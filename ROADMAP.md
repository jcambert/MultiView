...
| In Progress | US-DS-06 | Core des définitions | Validation JSON Schema | P1 | Validation renforcée implémentée (format, champs requis, champs inconnus configurables, références de champs inter-vues, tests unitaires). Reste: règles métier de cohérence avancées (widgets/contraintes croisées). |
